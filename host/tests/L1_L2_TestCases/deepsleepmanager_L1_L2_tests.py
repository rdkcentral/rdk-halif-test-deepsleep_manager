...
class deepsleepmanager_L1_L2_tests(utHelperClass):
    ...
    This class uses the `deepsleep` to interact with the device
    ...
    def __init__(self, log:logModule=None):
        ...
        """
        moduleName = "deepsleepmanager"

        testName = "deepsleepmanager_Test"
        qcId = "1"
...
if __name__ == '__main__':
    ...
    test = deepsleepmanager_L1_L2_tests(summeryLog)
    test.run(False)
