...
Example Test Setup configuration File: [deepsleepmanager_L1_L2_testSetup.yml](../../host/tests/L1_L2_TestCases/deepsleepmanager_L1_L2_testSetup.yml)
...
Example Test Setup configuration File: [deepsleep_testConfig.yml](../../host/tests/deepsleepClasses/deepsleep_testConfig.yml)
