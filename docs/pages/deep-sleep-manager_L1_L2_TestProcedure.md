# Deep Sleep Manager HAL L1 and L2 Test Procedure
...
Example Test Setup configuration File: [deepsleepmanager_L1_L2_testSetup.yml](../../ut/host/tests/L1_L2_TestCases/deepsleepmanager_L1_L2_testSetup.yml)
...
Example Test Setup configuration File: [deepsleepmanager_testConfig.yml](../../ut/host/tests/deepsleepClasses/deepsleepmanager_testConfig.yml)
...
```bash
python deepsleepmanager_L1_L2_tests.py --config </PATH>/ut/host/tests/configs/example_rack_config.yml --deviceConfig </PATH>/ut/host/tests/configs/deviceConfig.yml
```
